package bloodmatch.request.presentation.getdonationrequestsbypartyid;

import bloodmatch.request.application.GetDonationRequestsByPartyIdUseCase.OutputItem;
...
public record DonationRequestByPartyResponseDto(
    ...
    @Schema(description = "Fulfilled blood bags") BigDecimal fulfilledBloodBags,
    @Schema(description = "Remaining blood bags") BigDecimal remainingBloodBags,
