...
public record RegisterDonorDto(
    ...
    @Schema(description = "Optional date of the last donation (ISO-8601). Must not be in the future.", format = "date", requiredMode = Schema.RequiredMode.NOT_REQUIRED) LocalDate lastDonationDate) {
}
