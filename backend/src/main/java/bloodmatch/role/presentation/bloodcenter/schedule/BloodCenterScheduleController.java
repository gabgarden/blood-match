package bloodmatch.role.presentation.bloodcenter.schedule;

import bloodmatch.role.application.bloodcenter.schedule.GetBloodCenterScheduleUseCase;
import bloodmatch.role.application.bloodcenter.schedule.GetBloodCenterSlotsUseCase;
import bloodmatch.role.application.bloodcenter.schedule.GetBloodCenterSlotsUseCase.SlotOutput;
import bloodmatch.role.application.bloodcenter.schedule.UpsertBloodCenterScheduleUseCase;
import bloodmatch.role.application.bloodcenter.schedule.UpsertBloodCenterScheduleUseCase.WindowInput;
import bloodmatch.role.application.bloodcenter.schedule.UpsertBloodCenterScheduleUseCase.WindowOutput;
...
import static bloodmatch.shared.presentation.AuthenticatedPartySupport.authenticatedPartyId;
