package bloodmatch.auth.infrastructure.config;

import bloodmatch.auth.infrastructure.security.JwtAuthenticationFilter;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(GET, "/donation-requests/recommendations")
                .hasAnyAuthority("DONOR", "SYSTEM_ADMIN")
            .requestMatchers(POST, "/donation-requests/*/notify")
                .hasAnyAuthority("REQUESTER", "SYSTEM_ADMIN")
            .requestMatchers(GET, "/donation-requests/*")
                .hasAnyAuthority("REQUESTER", "SYSTEM_ADMIN")
            .requestMatchers(POST, "/donation-requests")
                .hasAnyAuthority("REQUESTER", "SYSTEM_ADMIN")
            .requestMatchers(DELETE, "/donation-requests/*")
                .hasAnyAuthority("REQUESTER", "SYSTEM_ADMIN")
            .requestMatchers(PATCH, "/donation-requests/goal-blood-bags")
                .hasAnyAuthority("REQUESTER", "SYSTEM_ADMIN")
