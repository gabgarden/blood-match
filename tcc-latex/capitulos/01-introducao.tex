...
O Capítulo~2 apresenta o referencial teórico (orientação a objetos, SOLID e DDD). O Capítulo~3 relata o mapeamento sistemático da literatura e os trabalhos relacionados. O Capítulo~4 descreve métodos, instrumentos e cronograma. O Capítulo~5 detalha a API RESTful proposta (requisitos, análise, design e implementação). O Capítulo~6 trata da avaliação. O Capítulo~7 reúne as considerações finais.
