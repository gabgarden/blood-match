...
Já A Tabela~\ref{tab:query} representa a \textit{query} (expressão de busca) que foi utilizada para a busca dos trabalhos relacionados na base de dados do Scopus.
...
Os critérios de inclusão (CI) e exclusão (CE) utilizados para selecionar os artigos são apresentados nA Tabela~\ref{tab:criterios}.
...
A pesquisa foi realizada em julho de 2025 e retornou 147 documentos. A Figura~\ref{graf:ano} apresenta a distribuição de artigos por ano. Observa-se que a maioria dos artigos encontrados são dos anos de 2020 e 2021.
...
A Figura~\ref{graf:pais} apresenta a distribuição de artigos por país, cujo país com maior quantidade de publicações é os Estados Unidos.
...
Sendo assim, a lista de artigos selecionados é apresentada nA Tabela~\ref{tab:artigos}.
