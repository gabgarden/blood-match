...
A representação gráfica dessas interações é dividida de acordo com o nível de acesso dos atores. A Figura~\ref{fig:uc-access-baseProfiles} apresenta o diagrama de caso de uso do ator (\textit{Guest}).
