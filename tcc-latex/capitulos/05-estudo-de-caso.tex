...
/*
discutir sobre a tabela
Exemplo de Fernando "discorrer que a lista é resumida para poder testar a teoria, que é um conjunto mínimo coeso de requisitos, levando em consideração a oferta, demanda e histórico de doações."
*/
...
/*
discutir sobre a tabela
Exemplo de Fernando "discuta que os requisitos não funcionais não trata de funcionalidades mas de características do software"
*/
...
A representação gráfica dessas interações é dividida de acordo com o nível de acesso dos atores. A Figura 3 apresenta o diagrama de caso de uso do ator (\textit{Guest}).
...
Já a Figura 4 representa o diagrama de caso de uso do ator (\textit{Requester}).
...
Por fim, a Figura 5 representa o diagrama de caso de uso do ator (\textit{Donor}).
