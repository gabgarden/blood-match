...
- Capítulos **1 a 4** integralmente convertidos
- Capítulo **5** até a modelagem de domínio (seções 5.5 e 5.6 marcadas como TODO)
- Capítulos **6 e 7** com estrutura pronta para preenchimento
